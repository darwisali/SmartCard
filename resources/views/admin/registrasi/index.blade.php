        ...
        <div class="col-md-12 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                  <a type="button" href="{{route('registrasi.create')}}" class="btn btn-success" style="float:right">Transaksi Baru</a>
                <h5 class="card-title fw-semibold mb-4">Pembayaran Registrasi</h5>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{ $row->semester }}</h6></td>
